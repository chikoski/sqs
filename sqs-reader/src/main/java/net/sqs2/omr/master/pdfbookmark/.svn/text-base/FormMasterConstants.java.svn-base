...
public class FormMasterConstants {
	public static final String SVG_G_ELEMENT_REPRESENTATION = "svg:g";
	public static final String METADATA_PAGE_ELEMENT_REPRESENTATION = "svg:metadata/reader:page";
	public static final String RECT_METADATA_STAR_ELEMENT_REPRESENTATION = "svg:rect/svg:metadata/*";
	public static final String RECT_METADATA_STAR_HINT_ELEMENT_REPRESENTATION = "svg:rect/svg:metadata/*/xforms:hint";
	public static final String NUMBER_ATTRIBUTE_REPRESENTATION = "number";
	...
	public static final String[][] LABEL_PATH = { { SQSNamespaces.XFORMS_URI, "item" },
			{ SQSNamespaces.XFORMS_URI, "label" } };

	public static final String[][] VALUE_PATH = { { SQSNamespaces.XFORMS_URI, "item" },
