...
public class PageID implements Serializable, Comparable<PageID>{
	...
	public PageID(FileResourceID fileResourceID, int index, int numPagesInFile){
	...
	public boolean equals(Object o) {
		try{
			...
			return (pageID.getIndex() == getIndex() &&
					pageID.getFileResourceID().equals(this.fileResourceID));
	...
	@Override
	public int hashCode(){
		return this.fileResourceID.hashCode() ^ this.index ^ this.numPagesInFile; 
	}
	...
	public String createID() {
		return createID(this.fileResourceID.getRelativePath(), this.fileResourceID.getLastModified(), this.index, this.numPagesInFile);
	}
