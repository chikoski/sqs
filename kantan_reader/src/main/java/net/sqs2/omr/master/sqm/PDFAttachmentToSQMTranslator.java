/*
 ...
 PDFAttachmentToSQMTranslator.java
...
public class PDFAttachmentToSQMTranslator extends AbstractTranslator {

	public PDFAttachmentToSQMTranslator(){
	}

	public void execute(InputStream pdfInputStream, String systemId, OutputStream sqmOutputStream) throws TranslatorException {
		try{
