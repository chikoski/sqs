...
SelectHandler.prototype = {
	...
	initialize: function(id, attr, optionSourceArray) {
		this.id = id;
		this.attr = attr;
	...
	createOptionGroup: function(optionSource){
		...
		if(optionSource.icon){
			optionGroup.setAttribute('style', 'background-image:url('+imagebase+'/'+optionSource.icon+')');
		}
	...
	createOption: function(optionSource){
		...
		if(optionSource.icon){
			option.setAttribute('style', 'background-image:url('+imagebase+'/'+optionSource.icon+')');
		}
		/*
...
ListBoxHandler.prototype = Object.extend(new SelectHandler(), {
	...
	initialize : function(id, attr, options) {
		SelectHandler.prototype.initialize.apply(this, [id, attr, options]);
